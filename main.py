...
if current_page == 'main':
    ...
    # Thêm CSS
    st.markdown('<p style="color:#74C365; font-size: 27px;"><strong>HIGH RISK OF DEATH!</strong></p>', unsafe_allow_html=True)

    st.markdown('<p style="color:#AEC6CF; font-size: 22px;"><em>The mortality rate for this patient is high when they contract COVID-19</em></p>', unsafe_allow_html=True)
    if st.button('BACK'):
        go_back()
else:
    if st.button('BACK'):
